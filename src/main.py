...
async def part1_attacks():
    ...
    # COMPLETED 1: Run manual adversarial prompts
    print("\n--- Running manual attacks (COMPLETED 1) ---")
    results = await run_attacks(agent, runner)

    # COMPLETED 2: Generate AI attack test cases
    print("\n--- Generating AI attacks (COMPLETED 2) ---")
...
async def part2_guardrails():
    ...
    _init_judge()  # Initialize LLM judge if COMPLETED 7 is done
    test_content_filter()
...
async def part3_testing():
    ...
    # COMPLETED 10: Before vs after comparison
    print("\n--- COMPLETED 10: Before/After Comparison ---")
    unprotected, protected = await run_comparison()
    if unprotected and protected:
        print_comparison(unprotected, protected)
    else:
        print("Complete COMPLETED 10 to see the comparison.")

    # COMPLETED 11: Automated security pipeline
    print("\n--- COMPLETED 11: Security Test Pipeline ---")
    agent, runner = create_unsafe_agent()
    ...
    if results:
        ...
        print("Complete COMPLETED 11 to see the pipeline report.")
...
def part4_hitl():
    ...
    # COMPLETED 13: HITL Decision Points
    print("\n--- COMPLETED 13: HITL Decision Points ---")
    test_hitl_points()
